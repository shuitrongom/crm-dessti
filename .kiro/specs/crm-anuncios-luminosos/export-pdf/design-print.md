...
<div class="diagram"><img class="mermaid-diagram" src="img/d1.png" alt="Diagrama 2" /></div>
...
Los submódulos de **Catálogo de Productos/Listas de Precios** (Req 59) y **Canal_Venta** (Req 63) residen dentro de `comercial`; el **inventario avanzado** (Req 60) dentro de `operacion`; y la **organización de personal** (Req 61) dentro de `rhnomina`, respetando las fronteras internas del monolito modular y permitiendo su extracción futura. Las capacidades de **redes sociales y mensajería omnicanal** (Req 64–66) residen en el módulo `social`, con el adaptador a las APIs de Meta aislado en `social.adapter.out.meta`.
...
<div class="diagram"><img class="mermaid-diagram" src="img/d3.png" alt="Diagrama 4" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d4.png" alt="Diagrama 5" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d5.png" alt="Diagrama 6" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d6.png" alt="Diagrama 7" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d7.png" alt="Diagrama 8" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d8.png" alt="Diagrama 9" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d9.png" alt="Diagrama 10" /></div>
...
<div class="diagram"><img class="mermaid-diagram" src="img/d10.png" alt="Diagrama 11" /></div>
