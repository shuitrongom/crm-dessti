...
/**
 * Adaptador por defecto del {@link IndicadorProduccionPort} que devuelve indicadores
 ...
 */
public class IndicadorProduccionVacio implements IndicadorProduccionPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.PRODUCCION);
    }
}
