...
/**
 * Adaptador por defecto del {@link IndicadorCxpPort} que devuelve indicadores vacios
 ...
 */
public class IndicadorCxpVacio implements IndicadorCxpPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.CXP);
    }
}
