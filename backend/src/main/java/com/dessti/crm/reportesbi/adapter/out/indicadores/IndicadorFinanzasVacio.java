...
/**
 * Adaptador por defecto del {@link IndicadorFinanzasPort} que devuelve indicadores
 ...
 */
public class IndicadorFinanzasVacio implements IndicadorFinanzasPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.FINANZAS);
    }
}
