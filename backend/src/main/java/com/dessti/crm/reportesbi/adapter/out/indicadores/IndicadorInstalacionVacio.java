...
/**
 * Adaptador por defecto del {@link IndicadorInstalacionPort} que devuelve indicadores
 ...
 */
public class IndicadorInstalacionVacio implements IndicadorInstalacionPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.INSTALACION);
    }
}
