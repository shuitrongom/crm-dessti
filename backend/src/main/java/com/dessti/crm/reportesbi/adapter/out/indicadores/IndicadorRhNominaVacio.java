...
/**
 * Adaptador por defecto del {@link IndicadorRhNominaPort} que devuelve indicadores
 ...
 */
public class IndicadorRhNominaVacio implements IndicadorRhNominaPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.RH_NOMINA);
    }
}
