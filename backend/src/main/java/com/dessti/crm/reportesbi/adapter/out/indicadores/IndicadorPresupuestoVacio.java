...
/**
 * Adaptador por defecto del {@link IndicadorPresupuestoPort} que devuelve indicadores
 ...
 */
public class IndicadorPresupuestoVacio implements IndicadorPresupuestoPort {

    @Override
    public IndicadoresArea agregar(FiltroIndicadores filtro) {
        return IndicadoresArea.vacio(AreaIndicador.PRESUPUESTO);
    }
}
