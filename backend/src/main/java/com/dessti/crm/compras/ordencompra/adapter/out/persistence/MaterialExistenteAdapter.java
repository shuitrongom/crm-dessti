...
import com.dessti.crm.compras.ordencompra.application.MaterialExistentePort;
 ...
 * {@link MaterialRepository} del modulo de inventario de Materiales (Req 31.1, 18).
 *
 ...
 */
@Component("ordenCompraMaterialExistenteAdapter")
